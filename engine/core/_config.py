...
class BaseConfig(object):
    ...
    def __init__(self) -> None:    
        ...
        self.plot_train_batch_freq :int = 1     
        self.output_dir :str = None
        self.summary_dir :str = None
        self.device :str = ''
        self.verbose_type :str = 'origin'   
    
        # cache
        self.cache_imgsz : int = 640   
        self.ram_cache : bool = False     

        self.yolo_metrice : bool = False
    
        # ----------------- distill start -----------------
    
        self.prune_model : bool = False     
        self.kd_loss_type: str = None  
        self.kd_loss_decay: str = None
        self.kd_loss_epoch: float = 1.0     

        self.logical_loss_type : str = 'single'
        self.logical_loss_ratio: float = 1.0

        self.teacher_kd_layers : list = None 
        self.student_kd_layers : list = None 
        self.feature_loss_type: str = 'cwd'    
        self.feature_loss_ratio: float = 1.0    
