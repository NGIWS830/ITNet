...
from ..extre_module.custom_nn.module.iRMB import iRMB 
...
__all__ = ['HGNetv2_MANet_iRMB'] 
    
class HG_Stage_MANet_iRMB(HG_Stage):
...
@register()
class HGNetv2_MANet_iRMB(HGNetv2):   
    arch_configs = {  
        'B0': { 
            ...
            'stage_config': {  
                ...
                "stage4": [256, 128, 512, 1, True, True, 5, 1],
            },
